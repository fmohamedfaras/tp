# Project Portfolio Page - Mohamed Faras S/O Faridul Huk

## Overview
**InventoryBRO** is a desktop application designed specifically for small shop owners to manage inventory and daily transactions efficiently using a Command Line Interface (CLI). While the application is optimised for users who prefer typing commands over clicking buttons, it provides a fast, reliable, and precise way to manage stock.
...
* Wrote the architectural design write-ups for the `Ui` component
* Documented the implementation details for "Deleting an Item" and "Finding an Item".
* Designed and generated comprehensive colored PlantUML diagrams to visualize the architecture:
    * **Class Diagrams:** `UiClassDiagram`, `DeleteClassDiagram`, `FindClassDiagram`.
...
* Reviewed and approved PRs for team members, ensuring their commands adhered to the decoupled Validator/Command architecture.
    * *Example:* [#61](https://github.com/AY2526S2-CS2113-W09-3/tp/pull/61), [#89](https://github.com/AY2526S2-CS2113-W09-3/tp/pull/89)