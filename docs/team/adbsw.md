...
InventoryBro is an inventory management tracking application interacted via a CLI. It is designed for storeowners who are looking to track their inventory of goods that they sell. It is written in Java.
